...
namespace Xyglo.Brazil.Xna
{
    // Courtesy of:
    //
    // http://recreationstudios.blogspot.nl/2009/04/boxes-cylinders-and-spheres-oh-my.html
    //
        ...
        public class Shape3D
        {
            ...
            public static Shape3D CreateTexturedBox(GraphicsDevice device, float width, float height, float depth)
            {
                ...
                shape.VertexBuffer = new VertexBuffer(device, typeof(VertexPositionNormalTexture), cubeVertices.Length, BufferUsage.WriteOnly);
                shape.VertexBuffer.SetData<VertexPositionNormalTexture>(cubeVertices);

                shape.VertexCount = 36;
                shape.TriangleCount = 12;
                //shape.VertexDeclaration = new VertexDeclaration();
                //shape.VertexSizeInBytes = sizeof(VertexPositionNormalTexture);
            ...
            public static Shape3D CreateBox(GraphicsDevice device, float width, float height, float depth)
            {
                ...
                shape.VertexBuffer = new VertexBuffer(device, typeof(VertexPositionNormalTexture), cubeVertices.Length, BufferUsage.None);
                ...
                shape.VertexDeclaration = new VertexDeclaration(VertexPositionNormal.VertexElements);
            ...
            public static Shape3D CreateSphere(GraphicsDevice device, float radius, int slices, int stacks)
            {
                ...
                shape.VertexBuffer = new VertexBuffer(device, typeof(VertexPositionNormalTexture), sphereVertices.Length, BufferUsage.None);
            ...
            public static Shape3D CreateCylinder(GraphicsDevice device, float bottomRadius, float topRadius, float length, int slices, int stacks)
            {
                ...
                shape.VertexBuffer = new VertexBuffer(device, typeof(VertexPositionNormalTexture), vertices.Length, BufferUsage.None);
