...
{
    public class XygloFinishBlock : XygloXnaDrawableShape
    {
        /// <summary>
        ...
        /// <param name="?"></param>
        public XygloFinishBlock(Color colour, BasicEffect effect)
        {
            m_colour = colour;
            m_effect = effect;
        ...
        public XygloFinishBlock(Color colour, BasicEffect effect, Vector3 position, Vector3 size)
        {
            // Store the effect
            m_effect = effect;
            m_colour = colour;
        ...
        /// <param name="position"></param>
        /// <param name="size"></param>
        public XygloFinishBlock(Color colour, BasicEffect effect, BrazilVector3 position, BrazilVector3 size)
        {
            // Store the effect
            m_effect = effect;
            m_colour = colour;
